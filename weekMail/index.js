...
function jietu() {
    (async () => {
        ...
        console.log('前往页面')
        await page.goto('http://192.168.60.127:8081/login');
        console.log('等待5秒')
        ...
        await page1.goto('http://192.168.60.127:8081/authc/productQueryCount/index');
        ...
        await page2.goto('http://192.168.60.127:8081/authc/consumerCount/index');
        ...
        await page3.goto('http://192.168.60.127:8081/authc/customerQueryMail/index');
